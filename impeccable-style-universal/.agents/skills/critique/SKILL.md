...
- **Command**: Which command to use (prefer: /polish, /harden, /onboard, /animate, /distill, /normalize, /arrange, /typeset, /bolder, /adapt, /critique, /clarify, /optimize, /audit, /extract, /quieter, /overdrive, /delight, /colorize — or other installed skills you're sure exist)
